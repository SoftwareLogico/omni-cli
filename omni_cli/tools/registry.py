...
from omni_cli.tools.core import ToolExecutionResult, ToolPayload
from omni_cli.tools.editor.apply_edits import execute_apply_text_edits
from omni_cli.tools.editor.edit import execute_edit_file
from omni_cli.tools.editor.write import execute_write_file
...
from omni_cli.tools.session.list_tasks import execute_list_tasks, execute_wait_task
from omni_cli.tools.shell.manage_commands import (
    execute_list_commands,
    execute_read_command_output,
    execute_stop_command,
    execute_wait_command,
)
from omni_cli.tools.shell.open_path import execute_open_path
from omni_cli.tools.schemas import get_tool_schemas
from omni_cli.tools.shell.run_command import execute_run_command
...
class ToolRegistry:
    ...
    def _delegate_task(self, arguments: dict[str, Any]) -> dict[str, Any]:
        from omni_cli.tools.session.delegate import execute_delegate_task
