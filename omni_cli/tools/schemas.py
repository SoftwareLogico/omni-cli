...
def get_tool_schemas() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "function": {
                "name": "list_tasks",
                "description": "List all delegated sub-agent tasks and their status (RUNNING/COMPLETED). DO NOT poll this tool repeatedly in a loop. Use wait_task to block until completion.",
        ...
        },
        {
            ...
            "function": {
                "name": "wait_task",
                "description": "Wait for a delegated background task (sub-agent) to complete. Returns the final report generated by the sub-agent.",
                "parameters": {
                    "type": "object",
                    "properties": {
